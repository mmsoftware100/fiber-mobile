class OneServiceModel {
  ...
  late final String serviceScheduleId;
  ...
  late final Serviceschedule serviceschedule;

  OneServiceModel.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
    serviceScheduleId = json['service_schedule_id'].toString();
    ...
    serviceschedule = Serviceschedule.fromJson(json['serviceschedule']);
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['id'] = id.toString();
    _data['service_schedule_id'] = serviceScheduleId.toString();
    ...
    _data['serviceschedule'] = serviceschedule.toJson();
    return _data;
  }
}
...
class Photos {
  Photos({
    required this.outputDbm,
    required this.onuSn,
    required this.onuOverall,
    required this.homeDbm,
  });
  late final OutputDbm outputDbm;
  late final OnuSn onuSn;
  late final OnuOverall onuOverall;
  late final HomeDbm homeDbm;

  Photos.fromJson(Map<String, dynamic> json){
    outputDbm = OutputDbm.fromJson(json['output_dbm']);
    onuSn = OnuSn.fromJson(json['onu_sn']);
    onuOverall = OnuOverall.fromJson(json['onu_overall']);
    homeDbm = HomeDbm.fromJson(json['home_dbm']);
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['output_dbm'] = outputDbm.toJson();
    _data['onu_sn'] = onuSn.toJson();
    _data['onu_overall'] = onuOverall.toJson();
    _data['home_dbm'] = homeDbm.toJson();
    return _data;
  }
}
...
class OutputDbm {
  ...
  OutputDbm.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
  ...
  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['id'] = id.toString();
    _data['service_id'] = serviceId.toString();
...
class OnuSn {
  ...
  OnuSn.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
    serviceId = json['service_id'].toString();
    name = json['name'].toString();
    photoTypeId = json['photo_type_id'].toString();
...
class OnuOverall {
  ...
  OnuOverall.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
    serviceId = json['service_id'].toString();
    name = json['name'].toString();
    photoTypeId = json['photo_type_id'].toString();
...
class HomeDbm {
  ...
  HomeDbm.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
    serviceId = json['service_id'].toString();
    name = json['name'].toString();
    photoTypeId = json['photo_type_id'].toString();
...
class Serviceschedule {
  ...
  Serviceschedule.fromJson(Map<String, dynamic> json){
    id = json['id'].toString();
